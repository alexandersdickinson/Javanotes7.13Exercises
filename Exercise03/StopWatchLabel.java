...
public class StopWatchLabel extends JLabel implements MouseListener {
	...
	private Timer elapsedTimer;//Determines interval for display of
    ...
    public void mousePressed(MouseEvent evt) {
        if (running == false) {
			...
			if(elapsedTimer == null){
	            elapsedTimer = new Timer(200, new ActionListener(){
            
					public void actionPerformed(ActionEvent evt){
					
						int elapsedSec = (int)(evt.getWhen() - startTime)/1000;
						setText("Elapsed: " + elapsedSec);
